...
function FeatureDetailComponent({ icon, title, detail }) {
    return (
        <div className='w-full h-full sm:w-[330px] sm:h-[320px] bg-white shadow-[6px_6px_0px_0px_rgba(71,181,255,1)] rounded-[2px] flex items-center px-12'>
            <div className='w-full h-full flex flex-col items-center  gap-y-4 py-10'>
                ...
                <div className='text-[22px] text-[#0B4C74]  font-bold text-center'>
                    <h1>{ title }</h1>
                </div>
