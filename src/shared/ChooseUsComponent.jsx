...
function ChooseUsComponent({ icon, headingOne, headingTwo, detail }) {
  return (
    <div className="w-full sm:w-[300px] h-[300px] sm:h-[400px] bg-white rounded-[20px] shadow-[40px_20px_80px_0px_rgba(101,115,137,0.10)] border border-gray-400/10 flex items-center px-8">
