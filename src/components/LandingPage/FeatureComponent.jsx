        ...
        <div className="w-full h-full flex sm:flex-row flex-col font-bold text-2xl">
          <div className="w-full sm:w-[40%] h-full flex justify-center   p-5 sm:p-10">
            <div className="sm:w-[350px] flex flex-col gap-y-5 w-full justify-center">
              <div className="text-xl text-white  font-OutFit sm:font-bold leading-tight">
              ...
              <div>
                <button className=" w bg-[#1D6996] sm:bg-[#FDD619] hover:sm:bg-[#e3c016] hover:bg-[#1a5e87] text-white [word-spacing:3px] sm:text-black duration-150 w-[178px] h-[66px] text-[17px] font-semibold font-Jakarta rounded-[8px] shadow-2xl shadow-black/40">
                  Get Started
                </button>
              </div>
            </div>
