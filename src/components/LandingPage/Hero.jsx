      ...
      <div className="w-full h-full absolute">
        <div className="w-[100%] h-full flex flex-col sm:flex-row  sm:px-14 md:px-16 lg:px-20px xl:px-24 2xl:px-28">
          ...
          <div className="w-full sm:w-[55%] h-full flex flex-col py-4  sm:py-10 justify-center">
            ...
            <div className="w-full px-3 sm:px-0 text-[#06283D] capitalize font-Jakarta text-lg lg:text-2xl xl:text-2xl 2xl:text-4xl">
              <h1 className="font-OutFit font-bold tracking-tighter">
                <span className="flex flex-col my-0 sm:-my-5  gap-y-0 sm:-gap-y-3">
                  <h1>
                    your{" "}
                    <WordStyled id="health_insurance" word="Health Insurance" />
                  </h1>
            ...
            <div className="font-Jakarta text-[#06283D99] w-full px-3 sm:pr-28 my-2">
              <h1 className="text-[15px] sm:text-[20px]">
                Welcome to Hauora Health, where we make Your Health Insurance
                simple, straightforward, and stress-free! Say goodbye to
                insurance jargon and confusion. Start comparing plans and take
                control of your coverage with confidence.
              </h1>
            </div>
