  ...
  return (
    <section className="w-full relative mb-14">
      ...
      <div className="relative">
        ...
        <div className=" w-full flex flex-col flex-wrap gap-y-14  sm:gap-y-5 sm:flex-row justify-center items-start sm:items-baseline  gap-x-0 sm:gap-x-20 px-5 sm:px-[100px] md:px-[130px] lg:px-[150px] xl:px-[180px] 2xl:px-[200px] my-20 z-50">
